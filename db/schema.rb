...
ActiveRecord::Schema.define(version: 2020_09_15_080305) do
  ...
  add_foreign_key "os_versions", "os_names", on_delete: :cascade
  add_foreign_key "phones", "body_colors", on_delete: :cascade
  add_foreign_key "phones", "memories", on_delete: :cascade
  add_foreign_key "phones", "models", on_delete: :cascade
  add_foreign_key "phones", "os_versions", on_delete: :cascade
